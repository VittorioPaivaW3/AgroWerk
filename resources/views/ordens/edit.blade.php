<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            {{-- Cabeçalho da OS --}}
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg border-l-4 border-gray-200">
                ...
                <div class="px-5 py-5 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="status"
                                    class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 text-sm focus:ring-emerald-500 focus:border-emerald-500">
                                @php
                                    $statusOptions = [
                                        'aberta'      => 'Aberta',
                                        'em_execucao' => 'Em execução',
                    ...
                    <div>
                        ...
                        <textarea
                            name="descricao"
                            rows="4"
                            class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 text-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('descricao', $ordem->descricao) }}</textarea>
                        @error('descricao')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="file"
                                   ...
                                   class="block w-full text-sm text-gray-900 dark:text-gray-100 file:mr-3 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100">
