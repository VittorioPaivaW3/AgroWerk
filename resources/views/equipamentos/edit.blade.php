                    ...
                    <form method="POST"
                        ...
                        <div>
                            ...
                            <label class="inline-flex items-center">
                                <input
                                    ...
                                    {{ old('tem_horimetro', $equipamento->tem_horimetro ?? false) ? 'checked' : '' }}
                                >
                        ...
                        <div>
                            ...
                            <input id="vida_util_h" name="vida_util_h" type="number" min="0" step="1"
                                   value="{{ old('vida_util_h', $equipamento->vida_util_h) }}"
                                   class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900
                                          text-sm text-gray-900 dark:text-gray-100 focus:border-verdes-verde_claro focus:ring-verdes-verde_claro">
                            @error('vida_util_h')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input id="horimetro" name="horimetro" type="number" min="0" step="0.01"
                                   value="{{ old('horimetro', $equipamento->horimetro) }}"
                                   class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900
                                          text-sm text-gray-900 dark:text-gray-100 focus:border-verdes-verde_claro focus:ring-verdes-verde_claro">
                            @error('horimetro')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            ...
                            <select id="tipo_equipamento_id" name="tipo_equipamento_id"
                                ...
                                @foreach ($tipos as $tipo)
                                    <option value="{{ $tipo->id }}"
                                        @selected(old('tipo_equipamento_id', $equipamento->tipo_equipamento_id) == $tipo->id)>
                                        {{ $tipo->nome }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        {{-- Foto de perfil --}}
                        <div class="rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50/70 dark:bg-gray-900/40 p-4 space-y-3">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <label class="inline-flex items-center text-sm text-gray-700 dark:text-gray-300">
                                        <input type="checkbox"
                                               ...
                                               value="1"
                                               class="h-4 w-4 rounded border-gray-300 text-red-600 shadow-sm focus:ring-red-500">
                                        <span class="ml-2">Remover foto atual</span>
                                    </label>
                                </div>
                            @endif
