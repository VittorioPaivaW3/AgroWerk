<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Cadastrar Tipo de Equipamento') }}
        </h2>
    </x-slot>
                ...
                <div class="px-6 py-6 text-gray-900 dark:text-gray-100">
                    <div class="flex flex-col gap-1 border-b border-gray-100 dark:border-white/10 pb-4">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-300">
                            Informe os dados basicos para classificar os equipamentos.
                        </p>
                    </div>

                    <form method="POST" action="{{ route('tipos.store') }}" class="mt-6 space-y-6">
                        @csrf
